...
public class OIMWebInterface extends ServletBase  {
	...
	class Content implements IView {
		...
		public void render(PrintWriter out) {
			...
			out.write("</li> <li> <a href=\"#Setting_the_Master_Password_Opti\"> Setting the Master Password (Optional)</a>");
			out.write("</li> <li> <a href=\"#Downloading_Certifying_Authority\"> Downloading Certifying Authority certificate files for OSG CILogon-based certificates</a> <ul>");
			out.write("<li> <a href=\"#Installing_Certifying_Authority\"> Installing Certifying Authority certificates into a web browser</a>");
			out.write("</li></ul> ");
			out.write("</li> <li> <a href=\"#Requesting_a_New_User_Certificat\"> Requesting a New User Certificate</a>");
			out.write("</li> <li> <a href=\"#VO_Registration\"> VO Registration</a> <ul>");
			out.write("<li> <a href=\"#Registration_Using_a_VOMS_Admin\"> Registration Using a VOMS-Admin Server</a>");
			out.write("</li></ul> ");
			out.write("</li> <li> <a href=\"#Exporting_the_Certificate_to_Dis\"> Exporting the Certificate to Disk</a>");
			out.write("</li> <li> <a href=\"#Transferring_the_Certificate_to\"> Transferring the Certificate to the Submit Host</a>");
			out.write("</li> <li> <a href=\"#Next_Steps\"> Next Steps</a>");
			out.write("</li></ul> ");
			out.write("</div>");
			out.write("<p />");
			...
			out.write("<br />    ");
			out.write("<img alt=\"set_master_password1.png\" src=\"https://twiki.grid.iu.edu/twiki/pub/Documentation/CertificateGetWeb/set_master_password1.png\" />");
			...
			out.write("<p />");
			out.write("       <img alt=\"CA_web.png\" src=\"https://twiki.grid.iu.edu/twiki/pub/Documentation/InstallCACertificatesWeb/CA_web.png\" />  <br />    ");
			out.write("<p />");
			...
			out.write("<p /> <ol>");
			out.write("<li> Go to Preferences -&gt; Advanced -&gt; Certificates -&gt; View Certificates -&gt; Authorities:       <p> <img alt=\"CA_absent.png\" src=\"https://twiki.grid.iu.edu/twiki/pub/Documentation/InstallCACertificatesWeb/CA_absent.png\" /></p>");
			out.write("</li> <li> Click \"Import\" and select the certificate just downloaded.       <p> <img alt=\"CA_import.png\" src=\"https://twiki.grid.iu.edu/twiki/pub/Documentation/InstallCACertificatesWeb/CA_import.png\" />  </p>");
			out.write("</li> <li> After you select the certificate, this window will be shown      <p> <img alt=\"CA_trust.png\" src=\"https://twiki.grid.iu.edu/twiki/pub/Documentation/InstallCACertificatesWeb/CA_trust.png\" />  </p>      Click on the first two \"Trust\" boxes and click \"OK\" to save it.");
			out.write("</li> <li> Successful import will show the new CA as follows      <p> <img alt=\"CA_present.png\" src=\"https://twiki.grid.iu.edu/twiki/pub/Documentation/InstallCACertificatesWeb/CA_present.png\" />  </p>");
			out.write("</li></ol> ");
			out.write("<p />");
			out.write("<p />");
			out.write("<p />");
			...
			out.write("</li> <li> Select the appropriate VO from the drop down menu.       <p> <img alt=\"select_vo.png\" src=\"https://twiki.grid.iu.edu/twiki/pub/Documentation/CertificateGetWeb/select_vo.png\" /> </p>");
			out.write("</li> <li> After having read through the OSG Policy Agreement, check the \"I AGREE\" box and click on Submit.      <p> <img alt=\"CA_agreement.png\" src=\"https://twiki.grid.iu.edu/twiki/pub/Documentation/CertificateGetWeb/CA_agreement.png\" />  </p>");
			out.write("</li></ol> ");
			out.write("<p />");
			...
			out.write("<img alt=\"vomsadmin_doneB.png\" src=\"https://twiki.grid.iu.edu/twiki/pub/Documentation/CertificateGetWeb/vomsadmin_doneB.png\" />");
			out.write("</span></span> <!--/twistyPlugin-->");
			out.write("<p />");
			...
			out.write("</li> <li> After pressing OK, you should see:<br />       <img alt=\"cert_export_acknowledgement.png\" src=\"https://twiki.grid.iu.edu/twiki/pub/Documentation/CertificateGetWeb/cert_export_acknowledgement.png\" />");
			out.write("</li></ol> ");
			out.write("<p />");
