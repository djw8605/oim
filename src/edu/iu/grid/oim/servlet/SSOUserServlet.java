...
public class SSOUserServlet extends ServletBase implements Servlet {
	...
	{	
		...
		bread_crumb.addCrumb("Authorization Type Mapping",  null);
		...
		throws ServletException
	{
		...
		IView mainview = new IView() {
			...
			public void render(PrintWriter out) {
			    //out.write("<p><a class=\"btn pull-right\" href=\"useredit\">Add Authorization Type Mapping</a></p>");	
				...
				out.write("<thead><tr><th>Name</th><th>Contact</th><th>Authorizatoin Types</th><th></th></tr></thead>");	

				out.write("<tbody>");
				try {

				    SSOModel model = new SSOModel(context);
				    SSOAuthorizationTypeModel dnauthmodel = new SSOAuthorizationTypeModel(context);
				    AuthorizationTypeModel authmodel = new AuthorizationTypeModel(context);
					...
					out.write("<td>");
					out.write("<a class=\"btn btn-mini\" href=\"ssouseredit?id="+rec.id+"\">Edit</a>&nbsp;");
					out.write("</td>");
