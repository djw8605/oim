...
out.write("<li> <a href='#OIM_Registration_Instructions'> OIM Registration Instructions</a> <ul>");
out.write("<li> <a href='#About_this_Document'> About this Document</a>");
out.write("</li> <li> <a href='#Requirements'> Requirements</a>");
out.write("</li> <li> <a href='#Registering_Yourself'> Registering Yourself</a> <ul>");
out.write("<li> <a href='#Required_Information'> Required Information</a>");
out.write("</li> <li> <a href='#Optional_Information'> Optional Information</a>");
out.write("</li></ul> ");
out.write("</li> <li> <a href='#Facility_Registration'> Facility Registration</a>");
out.write("</li> <li> <a href='#Site_Registration'> Site Registration</a> <ul>");
out.write("<li> <a href='#Required_Information_AN1'> Required Information</a>");
out.write("</li> <li> <a href='#Optional_Information_AN1'> Optional Information</a>");
out.write("</li></ul> ");
out.write("</li> <li> <a href='#Resource_Group_Registration'> Resource Group Registration</a> <ul>");
out.write("<li> <a href='#Required_Information_AN2'> Required Information</a>");
out.write("</li></ul> ");
out.write("</li> <li> <a href='#Resource_or_Service_Registration'> Resource or Service Registration</a> <ul>");
out.write("<li> <a href='#Required_Information_AN3'> Required Information</a>");
out.write("</li> <li> <a href='#Optional_Information_AN2'> Optional Information</a>");
out.write("</li></ul> ");
out.write("</li> <li> <a href='#VO_Registration'> VO Registration</a> <ul>");
out.write("<li> <a href='#Required_Information_AN4'> Required Information</a>");
out.write("</li> <li> <a href='#Optional_Information_AN3'>Optional Information</a>");
out.write("</li></ul> ");
out.write("</li> <li> <a href='#Support_Center_Registration'> Support Center Registration</a>");
out.write("</li> <li> <a href='#Removal_or_Deletion_of_OIM_Regis'> Removal or Deletion of OIM Registrations</a> <ul>");
out.write("<li> <a href='#When_to_Request_Deletion_of_an_O'> When to Request Deletion of an OIM Registration</a>");
out.write("</li> <li> <a href='#When_to_Request_Disabling_of_an'> When to Request Disabling of an OIM Registration</a>");
out.write("</li> <li> <a href='#Comments'> Comments</a>");
out.write("</li></ul> ");
out.write("</li></ul> ");
out.write("</li></ul> ");
out.write("</div>");
...
out.write("There are some situations in which the GOC will need to contact OSG users, such as in matters concerning the OSG <a "); out.write("href='http://osg-docdb.opensciencegrid.org/cgi-bin/RetrieveFile?docid=86&amp;extension=pdf' target='_top'>acceptable use policy</a>");
...
out.write("<p />");
out.write("<div class='twistyPlugin twikiMakeVisibleInline'>  <span id='twistyIdOperationsOIMRegistrationInstructions1show' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleopen-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Show...</span></a> </span> <span id='twistyIdOperationsOIMRegistrationInstructions1hide' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleclose-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Hide</span></a> </span>  </div><!--/twistyPlugin twikiMakeVisibleInline--> <div class='twistyPlugin'><div"); out.write("id='twistyIdOperationsOIMRegistrationInstructions1toggle' class='twistyContent twikiMakeHidden twistyInited'>");
out.write("<img src='https://twiki.grid.iu.edu/twiki/bin/viewfile/Operations/OIMRegistrationInstructions/OIM-5.png' border='0'>");
out.write("</div></div> <!--/twistyPlugin--> ");
out.write("<p />");
out.write("You should see 'Add Facility' button toward the top right corner of the page. ");
out.write("<p />");
out.write("<div class='twistyPlugin twikiMakeVisibleInline'>  <span id='twistyIdOperationsOIMRegistrationInstructions2show' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleopen-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Show...</span></a> </span> <span id='twistyIdOperationsOIMRegistrationInstructions2hide' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleclose-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Hide</span></a> </span>  </div><!--/twistyPlugin twikiMakeVisibleInline--> <div class='twistyPlugin'><div id='twistyIdOperationsOIMRegistrationInstructions2toggle' class='twistyContent twikiMakeHidden twistyInited'>");
out.write("<img src='https://twiki.grid.iu.edu/twiki/bin/viewfile/Operations/OIMRegistrationInstructions/OIM-7.png' border='0'>");
out.write("</div></div> <!--/twistyPlugin--> ");
out.write("<p />");
...
out.write("<p />");
out.write("<div class='twistyPlugin twikiMakeVisibleInline'>  <span id='twistyIdOperationsOIMRegistrationInstructions3show' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleopen-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Show...</span></a> </span> <span id='twistyIdOperationsOIMRegistrationInstructions3hide' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleclose-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Hide</span></a> </span>  </div><!--/twistyPlugin twikiMakeVisibleInline--> <div class='twistyPlugin'><div id='twistyIdOperationsOIMRegistrationInstructions3toggle' class='twistyContent twikiMakeHidden twistyInited'>");
out.write("<img src='https://twiki.grid.iu.edu/twiki/bin/viewfile/Operations/OIMRegistrationInstructions/OIM-5.png' border='0'>");
out.write("</div></div> <!--/twistyPlugin--> ");
out.write("<p />");
out.write("Navigate to the Facility that you'd like to add your site in, then click 'Add Site' button. ");
out.write("<p />");
out.write("<div class='twistyPlugin twikiMakeVisibleInline'>  <span id='twistyIdOperationsOIMRegistrationInstructions4show' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleopen-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Show...</span></a> </span> <span id='twistyIdOperationsOIMRegistrationInstructions4hide' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleclose-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Hide</span></a> </span>  </div><!--/twistyPlugin twikiMakeVisibleInline--> <div class='twistyPlugin'><div id='twistyIdOperationsOIMRegistrationInstructions4toggle' class='twistyContent twikiMakeHidden twistyInited'>");




out.write("<img src='https://twiki.grid.iu.edu/twiki/bin/viewfile/Operations/OIMRegistrationInstructions/oim-site-reg-1.png' border='0'>");
out.write("</div></div> <!--/twistyPlugin--> ");
out.write("<p />");
...
out.write("<p />");
out.write("<div class='twistyPlugin twikiMakeVisibleInline'>  <span id='twistyIdOperationsOIMRegistrationInstructions5show' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleopen-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Show...</span></a> </span> <span id='twistyIdOperationsOIMRegistrationInstructions5hide' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleclose-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Hide</span></a> </span>  </div><!--/twistyPlugin twikiMakeVisibleInline--> <div class='twistyPlugin'><div id='twistyIdOperationsOIMRegistrationInstructions5toggle' class='twistyContent twikiMakeHidden twistyInited'>");
out.write("<img src='https://twiki.grid.iu.edu/twiki/bin/viewfile/Operations/OIMRegistrationInstructions/OIM-5.png' border='0'>");
out.write("</div></div> <!--/twistyPlugin--> ");
out.write("<p />");
out.write("<p />");
...
out.write("<p />");
out.write("<div class='twistyPlugin twikiMakeVisibleInline'>  <span id='twistyIdOperationsOIMRegistrationInstructions6show' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleopen-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Show...</span></a> </span> <span id='twistyIdOperationsOIMRegistrationInstructions6hide' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleclose-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Hide</span></a> </span>  </div><!--/twistyPlugin twikiMakeVisibleInline--> <div class='twistyPlugin'><div id='twistyIdOperationsOIMRegistrationInstructions6toggle' class='twistyContent twikiMakeHidden twistyInited'>");
out.write("<img src='https://twiki.grid.iu.edu/twiki/bin/viewfile/Operations/OIMRegistrationInstructions/OIM-6.png' border='0'>");
out.write("</div></div> <!--/twistyPlugin--> ");
out.write("<p />");
...
out.write("<p />");
out.write("<div class='twistyPlugin twikiMakeVisibleInline'>  <span id='twistyIdOperationsOIMRegistrationInstructions7show' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleopen-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Show...</span></a> </span> <span out.write("id='twistyIdOperationsOIMRegistrationInstructions7hide' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleclose-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Hide</span></a> </span>  </div><!--/twistyPlugin twikiMakeVisibleInline--> <div class='twistyPlugin'><div id='twistyIdOperationsOIMRegistrationInstructions7toggle' class='twistyContent twikiMakeHidden twistyInited'>");
out.write("<img src='https://twiki.grid.iu.edu/twiki/bin/viewfile/Operations/OIMRegistrationInstructions/oim-resource-reg_1.png' border='0'>");
out.write("</div></div> <!--/twistyPlugin--> ");
out.write("<p />");
out.write("Navigate to the Resource Group that you'd like to register your resource in, then click the 'Add Resource' button.");
out.write("<p />");
out.write("<div class='twistyPlugin twikiMakeVisibleInline'>  <span id='twistyIdOperationsOIMRegistrationInstructions8show' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleopen-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Show...</span></a> </span> <span out.write("id='twistyIdOperationsOIMRegistrationInstructions8hide' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleclose-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Hide</span></a> </span>  </div><!--/twistyPlugin twikiMakeVisibleInline--> <div class='twistyPlugin'><div id='twistyIdOperationsOIMRegistrationInstructions8toggle' class='twistyContent twikiMakeHidden twistyInited'>
out.write("<img src='https://twiki.grid.iu.edu/twiki/bin/viewfile/Operations/OIMRegistrationInstructions/oim-resource-reg_2.png' border='0'>");
out.write("</div></div> <!--/twistyPlugin--> ");
out.write("<p />");
...
out.write("<p /> <ul>");
out.write("<li> <strong>Name</strong> - a short unique name for this resource that will appear in <a href='https://myosg.grid.iu.edu/' target='_top'>MyOSG</a> or other catalogs as an identifier for this resource out.write("<strong>the  Name should not include spaces. Use a dash (-) or underscore (_) instead.  If spaces are present, they will automatically be converted to underscores.</strong> *Also note that any special characters apart from [A-Z], [a-z], [0-9], [-_] will be removed by the validation code.");
...
out.write("</li> <li> <strong>Service</strong> - You can select which services your resource will run by selecting a service from the service menu. You can add more services by clicking the 'Add New Service' link. This is out.write("where you specify whether this resource is a Compute Element, a Storage Element, or other services.");
...
out.write("<li> <strong>Administrative Contact - Primary</strong> - This is the person we should call if a problem with the resource is not getting resolved via the OSG Support Center Model. Choose <strong>Assign out.write("New</strong>, from here you can find a currently registered OIM Contact or Add an Unlisted Contact. Add an Unlisted Contact should be used for mailing lists and non-registered contacts. (<strong>Note</strong> we would like all non-automated contacts to be registered with OIM and will actively pursue registration of individuals who are entered into the Unlisted Contact status.");
...
out.write("</li> <li> <strong>Security Contact - Secondary/Tertiary</strong> - A backup to the primary security contact. The same process as described for primary security contact is used for secondary security out.write("contact. Please do not repeat the primary contact information for secondary contact.");
...
out.write("<p />");
out.write("<div class='twistyPlugin twikiMakeVisibleInline'>  <span id='twistyIdOperationsOIMRegistrationInstructions9show' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img out.write("src='/twiki/pub/TWiki/TWikiDocGraphics/toggleopen-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Show...</span></a> </span> <span out.write("id='twistyIdOperationsOIMRegistrationInstructions9hide' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleclose-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Hide</span></a> </span>  </div><!--/twistyPlugin twikiMakeVisibleInline--> <div class='twistyPlugin'><div id='twistyIdOperationsOIMRegistrationInstructions9toggle' class='twistyContent twikiMakeHidden twistyInited'>");
out.write("<img src='https://twiki.grid.iu.edu/twiki/bin/viewfile/Operations/OIMRegistrationInstructions/OIM-4.png' border='0'>");
out.write("</div></div> <!--/twistyPlugin--> ");
out.write("<p />");
out.write("Then click the \"Add New Virtual Organization\" button to the right.");
out.write("<p />");
out.write("<div class='twistyPlugin twikiMakeVisibleInline'>  <span id='twistyIdOperationsOIMRegistrationInstructions10show' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img out.write("src='/twiki/pub/TWiki/TWikiDocGraphics/toggleopen-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Show...</span></a> </span> <span out.write("id='twistyIdOperationsOIMRegistrationInstructions10hide' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleclose-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Hide</span></a> </span>  </div><!--/twistyPlugin twikiMakeVisibleInline--> <div class='twistyPlugin'><div"); out.write("id='twistyIdOperationsOIMRegistrationInstructions10toggle' class='twistyContent twikiMakeHidden twistyInited'>");
out.write("<img src='https://twiki.grid.iu.edu/twiki/bin/viewfile/Operations/OIMRegistrationInstructions/OIM-2.png' border='0'>");
out.write("</div></div> <!--/twistyPlugin--> ");
out.write("<p />");
out.write("If this VO is a sub-VO, you can check the appropriate checkbox and select the parent VO.");
out.write("<p />");
out.write("<div class='twistyPlugin twikiMakeVisibleInline'>  <span id='twistyIdOperationsOIMRegistrationInstructions11show' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img out.write("src='/twiki/pub/TWiki/TWikiDocGraphics/toggleopen-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Show...</span></a> </span> <span out.write("id='twistyIdOperationsOIMRegistrationInstructions11hide' class='twistyTrigger twikiUnvisited twistyHidden twistyInited'><a href='#'><img src='/twiki/pub/TWiki/TWikiDocGraphics/toggleclose-small.gif' border='0' alt='' /><span class='twikiLinkLabel twikiUnvisited'>Hide</span></a> </span>  </div><!--/twistyPlugin twikiMakeVisibleInline--> <div class='twistyPlugin'><div"); out.write("id='twistyIdOperationsOIMRegistrationInstructions11toggle' class='twistyContent twikiMakeHidden twistyInited'>");
out.write("<img src='https://twiki.grid.iu.edu/twiki/bin/viewfile/Operations/OIMRegistrationInstructions/OIM-3.png' border='0'>");
out.write("</div></div> <!--/twistyPlugin--> ");
out.write("<p />");
...
out.write("<li> If you are not sure what a certain contact type means, please refer to <a href='https://twiki.grid.iu.edu/bin/view/Operations/OIMTermDefinition#Contact' target='_top'>the definitions page</a>.");
out.write("</li> <li> If a contact, whose name you are searching for, does not already exist in OIM, then you can instructing him or her to follow <a"); out.write("href='https://www.opensciencegrid.org/bin/view/Operations/OIMRegistrationInstructions#Registering_Yourself' target='_top'>these instructions</a>.");
out.write("</li></ul> ");
...
out.write("</li> <li> <strong>Membership Service URL (VOMS)</strong> - the URL for the <span class='twikiNewLink'>VOMS service<a"); out.write("href='/bin/edit/Documentation/AdminDocVOMS?topicparent=Operations.OIMRegistrationInstructions' rel='nofollow' title='VOMS service (this topic does not yet exist; you can create it)'>?</a></span>");
...
out.write("<p />");
out.write("To register a new support center, click on the '*Support Centers*' top menu item, and then click on the '*Add New Support Center*' button on the right hand side.  The instructions below give descriptions of each out.write("of the fields to be filled in on the form. <ul>");
...
out.write("</li> <li> <strong>Contacts</strong> section: Choose appropriate contacts by searching for name of a person, and selecting one.  <ul>");
out.write("<li> If you are not sure what a certain contact type means, please refer to <a href='https://twiki.grid.iu.edu/bin/view/Operations/OIMTermDefinition#Contact' target='_top'>the definitions page</a>.");
out.write("</li> <li> If a contact, whose name you are searching for, does not already exist in OIM, then you can add them by instructing him or her to follow <a"); out.write("href='https://www.opensciencegrid.org/bin/view/Operations/OIMRegistrationInstructions#Registering_Yourself' target='_top'>these instructions</a>.");
out.write("</li></ul> ");
